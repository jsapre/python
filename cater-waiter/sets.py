...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    is_alchoholic = not set(drink_ingredients).isdisjoint(ALCOHOLS)
    if is_alchoholic:
...
def compile_ingredients(dishes):
    ...
    for dish_ingredient in dishes:
        master_ingredients = master_ingredients | dish_ingredient
